...
#import "WJTouchVC.h"
#import "WJTouchID.h"
@interface WJTouchVC ()<WJTouchIDDelegate>
...
-(void)setupUI{
    _Notice = [[UILabel alloc] initWithFrame:CGRectMake(0, 64, [[UIScreen mainScreen] bounds].size.width, 20)];
    
    [self.view addSubview:_Notice];
    
    UIButton *clickBtn = [UIButton buttonWithType:UIButtonTypeCustom];
    [clickBtn setImage:[UIImage imageNamed:@"fingerprint"] forState:UIControlStateNormal];
    [clickBtn sizeToFit];
    clickBtn.frame = CGRectMake(150, 140,clickBtn.frame.size.width,clickBtn.frame.size.height );
    [clickBtn addTarget:self action:@selector(StartWJTouchID) forControlEvents:UIControlEventTouchUpInside];
