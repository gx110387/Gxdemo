...
@interface YZPullDownMenuVC ()<YZPullDownMenuDataSource>
@property (nonatomic, strong) NSArray *titles;

@end

@implementation YZPullDownMenuVC
...
- (void)viewDidLoad {
    ...
    menu.frame = CGRectMake(0, 64+20, YZScreenW, 44);
